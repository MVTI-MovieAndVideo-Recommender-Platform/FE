    ...
    return (
        <div className="p-4 bg-gray-900 min-h-screen text-white flex flex-col items-center">
            <div className="flex items-center mb-4 w-4/5">
                <button className="btn btn-primary mr-2" onClick={toggleFilter}>Filter</button>
                {!isFilter && (
                    <input
                        type="text"
            ...
            {isFilter && (
                <div className="flex flex-wrap gap-2 justify-center w-full mb-4">
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Country')}>Country</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Genre')}>Genre</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Year')}>Year</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Keyword')}>Keyword</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Title')}>Title</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Director')}>Director</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Actor')}>Actor</button>
                    <button className="btn btn-primary" onClick={() => handleFilterButtonClick('Platform')}>Platform</button>
                </div>
            )}
            ...
            {loading ? (
                <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center w-full h-full">
                    <LoadingSpinner />
                </div>
            ) : (
                <div className="flex flex-wrap gap-4 justify-center w-4/5">
                    {results.map((result) => (
                        <div key={result.id} className="bg-gray-800 rounded overflow-hidden w-full md:w-1/2 lg:w-1/4 xl:w-1/6 text-center  cursor-pointer" onClick={() => handleClick(result.id)}>
